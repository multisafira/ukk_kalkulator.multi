...
<html lang="id">
    ...
    <body> 
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <form method="POST" class="p-2 border rounded bg-light">
                        ...
                        <input type="text" name="angka1" class="form-control" value="<?php echo isset($_SESSION['memory']) ? $_SESSION['memory'] : ''; ?>" required>
                        ...
                        <div class="d-flex justify-content-center gap-2 mt-2">
                            ...
                            <button type="submit" class="btn btn-success" name="operator" value="-" title="Kurang"><i class="fas fa-minus"></i></button>
                            <button type="submit" class="btn btn-primary" name="operator" value="*" title="Kali"><i class="fas fa-xmark"></i></button>
                            <button type="submit" class="btn btn-success" name="operator" value="/" title="Bagi"><i class="fas fa-divide"></i></button>
                            
                            <button type="reset" class="btn btn-danger" title="Clear Entry">CE</button>
                        </div>
                    </form> 
                    ...
                    <div class="p-1 border rounded bg-light">
                        ...
                        <div class="row mt-2">
                            <div class="col-6 text-end">
                                <form method="POST">
                                    <button type="submit" name="memory" class="btn btn-warning" title="Memory Entry">ME</button>
                                </form>
                            </div>
                            <div class="col-6 text-start">
                                <form method="POST">
                                    <button type="submit" name="resetmemory" class="btn btn-warning" title="Memory Clear">MC</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <p class="text-center">&copy; UKK RPL 2025 | Multisafira | XII PPLG</p>
